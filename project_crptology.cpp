      ...
      case 1:cout<<"\tENCIPHERING\n";
            ...
            switch(n2)
            {
              ...
              case 6:cout<<"\tBifid encipher\n";
                    a6.cipher();
                    break;
              case 7:cout<<"\tContinuous square encipher\n";
                    a7.cipher();
                    break;
              case 8:break;
            }
      ...
      case 2:cout<<"\tDECIPHERING\n";
            ...
            switch(n2)
            {
              ...
              case 6:cout<<"\tBifid decipher\n";
                    a6.decipher();
                    break;
              case 7:cout<<"\tContinuous decipher\n";
                    a7.decipher();
                    break;
              case 8:break;
            }
      ...
      case 3:cout<<"\tHISTORY\n";
             ...
             switch(n3)
             {
               ...
               case 6:cout<<"\tBifid cipher history\n";
                      bifid();
                      break;
               case 7:cout<<"\tContinuous square history\n";
                      continuous();
                      break;
             }
             break;
      case 4:SetConsoleTextAttribute(h,FOREGROUND_BLUE|FOREGROUND_INTENSITY);
             for(int i=0;i<50;++i)
             {
               cout<<"THANKYOU";
               usleep(60000);
...
void continuous()
{
  fstream f;
  char z[80];
  f.open("Continuous.txt",ios::in);
  while(f.getline(z,80))
  {
    cout<<z<<endl;
  }
  f.close();
